...
connect(
  "mongodb+srv://root:root@bedu.szozgxr.mongodb.net/jwt?retryWrites=true&w=majority"
)
  .then(()=> console.log("> Conetado a mongo Atlas"))
  .catch((e) => console.log(e, ">Error"));

const UserSchema = new Schema({
  email: {type: String, required: true, unique: true, maxlength: 100},
  password: {type: String, required: true, maxlength: 50, minlenght: 8},
},
  {timestamps: true}
);
